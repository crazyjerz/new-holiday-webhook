...
for i in holidayList:
    greeting = "Happy"
    filtered = [{"lgbt", "trans ", "sexual", "gender", "daylight", "robert e. lee"}, {"death", "demise", "assassination", "martyrdom", "good friday", "mourning", "catastrophe", "memorial", "fast", "tisha", "kippur", "asarah", "gold star"}]
    for k in filtered[0]: 
